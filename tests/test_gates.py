...
def test_detect_risk_human_request_en():
    """Val3: paritate EN pentru cererea de om (RO era solid, EN „fără risk_terms")."""
...
def test_detect_risk_legal_complaint_en():
...
def test_detect_risk_negative():
    ...
    # negative EN — produs normal, fără risk terms
