...
flowchart TD
  ...
  LANG["2 · Detectăm limba: RO / EN<br/>(language.py:27)"]:::stage
...
flowchart TD
  ...
  BDG["badge from REAL signals only<br/>deal > top, DomainPack thresholds<br/>badges.py:36-77 — gated card_badges_enabled"]:::free
...
7. **Fallback-ul final e doar în română** — `src/worker/runner.py:173-176`, deși pipeline-ul e RO/EN și triage are `_CLARIFY_FALLBACK` per-locale (`src/worker/stages/triage.py:313`). Încalcă P11.
...
compare_with_similar_enabled = true
...
price_bound_unit_aware_enabled = true
...
rich_card_reconcile_enabled = true
rich_facets_enabled = true
rich_from_facts_enabled = true
rich_item_handles_enabled = true
...
routine_arg_provenance_enabled = true
...
search_subshelf_homograph_guard_enabled = true
search_text_gate_when_redundant_enabled = true
set_relative_badges_enabled = true
...
unique_name_prefix_enabled = true
