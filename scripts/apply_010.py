"""Aplică docs/010_usage_cached_tokens.sql pe Supabase și verifică coloana (NX-78 cost obs).
...
SQL_FILE = Path(__file__).parent.parent / "docs" / "010_usage_cached_tokens.sql"
...
async def main():
    ...
    results = []
    try:
        print("1. Aplic 010_usage_cached_tokens.sql (de două ori — idempotent) ...")
