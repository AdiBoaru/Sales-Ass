...
FAMILIES: dict[str, list[str]] = {
    ...
    "par": [
        ...
        "ulei de par", "tratament de par", "ser de par", "spray de par", "balsam",
    ],
}
# Beneficii de skincare-față (pe ORICE produs non-skincare = nonsens).
SKIN_FACE = [
    "hidratare", "calmare", "riduri", "anti-rid", "anti-aging", "anti-imbatranire",
    "luminozitate", "uniformizare", "acnee", "pete", "pori", "cearcan", "fermitate",
    "exfoliere", "ten gras", "ten uscat", "ten sensibil", "ten mixt", "ten normal",
]
...
SKIN_ONLY = [
    "riduri", "anti-rid", "anti-aging", "anti-imbatranire", "luminozitate", "uniformizare",
    "acnee", "pete", "pori", "cearcan", "exfoliere", "ten gras", "ten uscat", "ten sensibil",
    "ten mixt", "ten normal",
]
