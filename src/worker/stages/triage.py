...
- "sales"   : caută/întreabă despre produse, recomandări, prețuri, comparații, DISPONIBILITATE
  („e pe stoc?", „mai aveți?") și CUM să cumpere/comande un produs („cum îl comand?", „cum cumpăr?",
...
- „Cum comand / cum cumpăr / cum plasez comanda" și „e pe stoc / mai aveți / e disponibil" fac parte
  din procesul de CUMPĂRARE → „sales", NU „order". O politică GENERALĂ (cum se face un retur, cât e
  livrarea, ce garanție) fără referire la comanda LUI = fapt de business → „sales" (agentul răspunde
  din baza de cunoștințe). Pune „order" DOAR când clientul se referă la o comandă a LUI deja plasată
